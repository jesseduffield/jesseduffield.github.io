...
## Compare The Permutations Yourself

Have a go selecting high/low for the three axe and compare one permutation to the next.
...
<html>
  <style>
    ...
    #domainInterdependence-no:checked ~ #practicalInterdependence-no:checked ~ #colocation-no:checked ~ .a1 { display: block; }
    #domainInterdependence-no:checked ~ #practicalInterdependence-yes:checked ~ #colocation-no:checked ~ .a2 { display: block; }
    #domainInterdependence-yes:checked ~ #practicalInterdependence-no:checked ~ #colocation-no:checked ~ .a3 { display: block; }
    #domainInterdependence-yes:checked ~ #practicalInterdependence-yes:checked ~ #colocation-no:checked ~ .a4 { display: block; }
    #domainInterdependence-no:checked ~ #practicalInterdependence-no:checked ~ #colocation-yes:checked ~ .a5 { display: block; }
    #domainInterdependence-no:checked ~ #practicalInterdependence-yes:checked ~ #colocation-yes:checked ~ .a6 { display: block; }
    #domainInterdependence-yes:checked ~ #practicalInterdependence-no:checked ~ #colocation-yes:checked ~ .a7 { display: block; }
    #domainInterdependence-yes:checked ~ #practicalInterdependence-yes:checked ~ #colocation-yes:checked ~ .a9 { display: block; }

  </style>

<span class="label">Domain Interdependence:</span>
<label for="#domainInterdependence-no">Low</label>
<input id="domainInterdependence-no" type="radio" name="domainInterdependence" value="no" checked="checked">
<label for="#domainInterdependence-yes">High</label>
<input id="domainInterdependence-yes" type="radio" name="domainInterdependence" value="yes">

  <br/>

<span class="label">Practical Interdependence:</span>
<label for="#practicalInterdependence-no">Low</label>
<input id="practicalInterdependence-no" type="radio" name="practicalInterdependence" value="no" checked="checked">
<label for="#practicalInterdependence-yes">High</label>
<input id="practicalInterdependence-yes" type="radio" name="practicalInterdependence" value="yes">

  <br/>

<span class="label">Colocation:</span>
<label for="#colocation-no">Low</label>
<input id="colocation-no" type="radio" name="colocation" value="no" checked="checked">
<label for="#colocation-yes">High</label>
<input id="colocation-yes" type="radio" name="colocation" value="yes">

<div class="hide a1">
  <p>Outcome: Programmer Nirvana!</p>
  <img src="{{ site.baseurl }}/images/posts/dependencies/loose.png" />
</div>
<div class="hide a2">
  <p>Outcome: BAD</p>
  <img src="{{ site.baseurl }}/images/posts/dependencies/node.png" />
</div>
<div class="hide a3">
  <p>Outcome: BAD</p>
  <img src="{{ site.baseurl }}/images/posts/dependencies/non-dry.png" />
</div>
<div class="hide a4">
  <p>Outcome: BAD</p>
  <img src="{{ site.baseurl }}/images/posts/dependencies/microservice.png" />
</div>
<div class="hide a5">
  <p>Outcome: Not that bad</p>
  <img src="{{ site.baseurl }}/images/posts/dependencies/low-cohesion.png" />
</div>
<div class="hide a6">
  <p>Outcome: BAD</p>
  <img src="{{ site.baseurl }}/images/posts/dependencies/wrong-abstraction.png" />
</div>
<div class="hide a7">
  <p>Outcome: Okay</p>
  <img src="{{ site.baseurl }}/images/posts/dependencies/cohesive-not-dry.png" />
</div>
<div class="hide a9">
  <p>Outcome: Programmer Nirvana!</p>
  <img src="{{ site.baseurl }}/images/posts/dependencies/high-cohesion.png" />
</div>
</html>
